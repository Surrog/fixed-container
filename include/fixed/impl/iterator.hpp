...
namespace _impl
{
    ...
    template <typename STORAGE> struct wrap_pointer_iterator
    {
    public:
        typedef typename std::remove_pointer<typename STORAGE::value_type>::type
            value_type;
        typedef value_type* pointer;
        typedef value_type& reference;
        typedef std::ptrdiff_t difference_type;
        ...
        const STORAGE& get() const { return _value; }
        ...
        wrap_pointer_iterator& operator=(const wrap_pointer_iterator&)
            = default;
        wrap_pointer_iterator& operator=(wrap_pointer_iterator&&) noexcept
            = default;
        ...
        wrap_pointer_iterator operator++(int)
        {
            assert(_value != nullptr);
            wrap_pointer_iterator result = (*this);
            ++(*this);
            return result;
        }
    ...
    template <typename STORAGE> struct const_wrap_pointer_iterator
    {
    public:
        typedef typename std::remove_pointer<typename STORAGE::value_type>::type
            value_type;
        ...
        const_wrap_pointer_iterator(const const_wrap_pointer_iterator&)
            = default;
        const_wrap_pointer_iterator(const_wrap_pointer_iterator&&) noexcept
            = default;
        const_wrap_pointer_iterator& operator=(
            const const_wrap_pointer_iterator&)
            = default;
        const_wrap_pointer_iterator& operator=(
            const_wrap_pointer_iterator&&) noexcept
            = default;

        template <typename RSTORAGE>
        const_wrap_pointer_iterator(const wrap_pointer_iterator<RSTORAGE>& orig)
            : _value(orig.get())
        {
        }
        ...
        const_wrap_pointer_iterator operator++(int)
        {
            assert(_value != nullptr);
            const_wrap_pointer_iterator result = (*this);
            ++(*this);
            return result;
        }
    ...
    auto operator+(std::ptrdiff_t lval, const wrap_pointer_iterator<STO>& rval)
    {
        return rval + lval;
    }
    ...
    template <typename STO>
    auto operator+(
        std::ptrdiff_t lval, const const_wrap_pointer_iterator<STO>& rval)
    {
        return rval + lval;
    }
}
