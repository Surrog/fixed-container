...
template <typename T, fixed::_impl::container_size_type LSIZE, fixed::_impl::container_size_type RSIZE,
...
bool operator==(const fixed::vector<T, LSIZE, LALLOC>& lval, const fixed::vector<T, RSIZE, RALLOC>& rval)
{
